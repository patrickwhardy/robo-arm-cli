...
// moves is an extensible object to make GamerInstance generic,
// moves stateless and adding moves to the game simple
const moves = {
  size: {
    argCount: 1,
    validate: () => {},
  ...
  replay: {
    ...
    // replay is not part of command history
    undo: () => {}
  },
  undo: {
    argCount: 1,
    ...
    // undo is not part of command history
    undo: () => {}
  }
}
...
function handleUndo(move, args, slots, executedCommands) {
